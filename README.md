# Цель системы
Сократить расходы на выполнение полетного задания БПЛА
## Описание цели
В настоящий момент заказчик использует ПО от geoscanner для которого необходимы дроны от данной компании. Обслуживание и ремонт данных дронов обходится очень дорого.
ПО mission planner от ardupilot совместим со многими моделями БПЛА, однако главным недостатком этого ПО является его сложность и большое кол-во лишних параметров требуемых настройки.
С цель сократить расходы на выполнение полетного задания, будет провидится работы над mission planner от ardupilot для его симплификации и расширения базовых функций
# Задачи (могут пополнятся в процессе работы)
- Релизовать систему проектов
  - Сохранения проектов в отдельный файл
  - Загрузка проектов
- Добавить возможность создания нескольких полётных заданий в рамках одного проекта
- Добавить представление иерархии проекта в виде деревовидной структуры
- Обеспечить работоспособность функции автоматического формирования маршрута по дефолту
# План-график
до 29 марта - Обеспечить работоспособность функции автоматического формирования маршрута по дефолту
до 1 апреля - Добавить возможность создания нескольких полётных заданий в рамках одного проекта
до 1 мая - Релизовать систему проектов
до 20 мая - Добавить представление иерархии проекта в виде деревовидной структуры
